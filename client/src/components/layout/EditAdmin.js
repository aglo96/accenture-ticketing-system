  ...
  onSubmit = (e) => {
    ...
    axios.put('/api/tickets/'+this.props.match.params.id, { title, description,  category, status,admin })
      .then((result) => {
        ...
        this.props.history.push({pathname: "/admin/dashboard/show/" + this.props.match.params.id})
      });
  }
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class = "row">
              ...
              <div class="input-field col s12">
                <select onChange = {this.onChange} class = "form-control" name = "status" value = {this.state.book.status} >
